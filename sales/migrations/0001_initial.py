# Generated by Django 4.1.3 on 2023-10-02 16:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateNaissance', models.DateTimeField(verbose_name='Date de Naissance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dateLivraison', models.DateTimeField(blank=True, null=True, verbose_name='date Livraison')),
                ('dateEnregistrement', models.DateTimeField(default=django.utils.timezone.now)),
                ('codeClient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.client', verbose_name='Client')),
                ('panier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.panier', verbose_name='Panier')),
            ],
        ),
    ]
